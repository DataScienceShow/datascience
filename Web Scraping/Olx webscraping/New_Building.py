...
for num_of_rooms in range(1, 6):
    url = f"https://www.olx.uz/d/nedvizhimost/kvartiry/prodazha/tashkent/?currency=UYE&search%5Border%5D=created_at:desc&search%5Bfilter_float_number_of_rooms:from%5D={num_of_rooms}&search%5Bfilter_float_number_of_rooms:to%5D={num_of_rooms}&search%5Bfilter_enum_type_of_market%5D%5B0%5D=primary"
    ...
    # df3.to_sql(name=f'new_building', con=conn, if_exists='append', index=False)
    # # close the database connection
    ##"C:\Data Scients\Learn Data Science\Kaggle projects\1 Kaggle projects\new building.csv"
    # conn.close()
    # Specify the CSV file to write to
    csv_file = 'C:\\Data Scients\\Learn Data Science\\Kaggle projects\\1 Kaggle projects\\new building.csv'
